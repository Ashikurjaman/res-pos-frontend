...
interface Props {
  ...
  totalAmount: number;
  setEditedProducts: (products: number[]) => void;
  printedItems?: number[];
}
...
export default function AddToCartProduct({
  ...
  const handleEdit = useCallback(
    ...
    [editedProducts, onEditProduct, setEditedProducts],
  );
  ...
  const alertMessage = useCallback((stock: number) => {
                  ...
                  >
                    ...
                    <TableCell className="px-4 py-3">
                      <div className="flex items-center gap-2 flex-wrap">
                        <span
                          className={`font-medium ${printed ? "text-red-700" : "text-gray-800"}`}
                        >
                    ...
                    <TableCell className="px-4 py-3 text-center">
                      <div className="flex items-center justify-center gap-1">
                        <button
                          ...
                          className="p-1 rounded-lg border border-gray-300 hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500"
                          disabled={
                            product.quantity <= 1 || isOutOfStock || printed
                          }
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (newQty > product.stock) {
                              alert(alertMessage(product.stock));
                              return;
                            }
